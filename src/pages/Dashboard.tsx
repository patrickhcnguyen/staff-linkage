...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Here you would fetch the user's profile, upcoming jobs, and achievements
  ...
  // Placeholder calculation for profile completion
  const profileItems = {
    avatar: false,
    name: false,
    role: false,
            ...
            >
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">Event Staff</p>
